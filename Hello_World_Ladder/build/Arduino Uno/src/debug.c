...
char plc_program_md5[] = "8d60cfc7f7e2348264ff725098fd0b53";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.BLINK_STATUS), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER1.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER1.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER1.IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER1.PT), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER1.Q), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER1.ET), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER1.STATE), SINT_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER1.PREV_IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER1.CURRENT_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER1.START_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER2.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER2.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER2.IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER2.PT), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER2.Q), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER2.ET), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER2.STATE), SINT_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER2.PREV_IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER2.CURRENT_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.BLINK_TIMER2.START_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.WAIT_TIME), TIME_ENUM},
